    ...
    class ReduxFramework_repeater
    {
        ...
        function localize($field, $value = "")
        {
            ...
            if (isset($field['fields']) && !empty($field['fields'])) {
                ...
                $var = ob_get_contents();
                $var = array('html' => $var . '<a href="javascript:void(0);" class="button deletion redux-repeaters-remove">Delete </a>', 'count' => count($value), 'sortable' => true, 'limit' => '', 'name' => $this->parent->args['opt_name'] . '[' . $field['id'] . '][99999]');
