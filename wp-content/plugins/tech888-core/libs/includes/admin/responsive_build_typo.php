...
if ( ! class_exists( 'Tech888fResVCBuildTypo' ) ) {
	/**
	 * VC Tech888fResVCBuildCSS Class
	 *
	 * @since	1.0
	 */
	class Tech888fResVCBuildTypo {
			...
			foreach ( $shortcodes[2] as $index => $tag ) {
				...
				if ( isset( $shortcode['params'] ) && ! empty( $shortcode['params'] ) ) {
					foreach ( $shortcode['params'] as $param ) {
						...
						if ( 'tech888f_typography' === $param['type'] && isset( $attr_array[ $param['param_name'] ] ) && array_key_exists($param['param_name'], $this->screens) ) {
